...
export function PomodoroTimerDisplay({
  ...
  const renderStatusBadge = () => {
    if (pomodoroState === "idle") return { text: "READY TO FOCUS", color: "text-muted-foreground border-border bg-card/60", dot: "bg-muted-foreground" };
    if (pomodoroState === "focusing") return { text: "DEEP WORK", color: "text-cyan-400 border-cyan-500/30 bg-cyan-500/10", dot: "bg-cyan-400 animate-pulse" };
    if (pomodoroState === "breaking") return { text: "TAKE A BREAK", color: "text-emerald-400 border-emerald-500/30 bg-emerald-500/10", dot: "bg-emerald-400 animate-pulse" };
    if (pomodoroState === "finished") return { text: "SESSION COMPLETED", color: "text-indigo-400 border-indigo-500/30 bg-indigo-500/10", dot: "bg-indigo-400" };
    if (pomodoroState === "paused") return { text: "PAUSED", color: "text-amber-400 border-amber-500/30 bg-amber-500/10", dot: "bg-amber-400" };
      ...
      <div className={cn(
        ...
        <div className="flex items-center justify-between w-full px-1 mb-4 sm:mb-6 lg:mb-8">
          <div className={cn(
            ...
            isVideoBackground ? "bg-white/10 backdrop-blur-md border-white/20 text-white shadow-lg" : "",
            status.color
          )}>
          ...
          <div className={cn(
            ...
            isVideoBackground ? "bg-white/10 backdrop-blur-md border-white/20 text-white shadow-lg" : "bg-card/80 backdrop-blur-md border-border"
          )}>
            <span>
                ...
                <div
                  ...
                  className={cn(
                    ...
                    i < currentSession - 1
                      ...
                      ? "bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.9)] scale-125"
                      : "bg-white/30"
                  )}
                />
              ))}
        ...
        <div className="text-center mb-4 sm:mb-6 lg:mb-8 px-4 max-w-lg lg:max-w-2xl xl:max-w-3xl">
          <h2 className={cn(
            ...
            isVideoBackground ? "text-white drop-shadow-[0_4px_16px_rgba(0,0,0,0.9)]" : "text-foreground drop-shadow-xs"
          )}>
            {activeTask.title}
          </h2>
        </div>
        ...
        <div className="relative flex items-center justify-center gap-2 sm:gap-4 md:gap-5 lg:gap-7 xl:gap-8 my-2 sm:my-3 lg:my-5 select-none">
            ...
            <>
              <div className="flex flex-col items-center">
                <div className={cn(
                  ...
                  isVideoBackground ? "bg-white/10 backdrop-blur-xl border-white/25 shadow-[0_8px_32px_rgba(0,0,0,0.3)]" : "bg-card/90 backdrop-blur-xl border-border"
                )}>
              ...
              <span className="text-2xl sm:text-3xl lg:text-4xl font-bold text-cyan-300 drop-shadow-[0_0_12px_rgba(34,211,238,0.8)] pb-6 lg:pb-8 animate-pulse">:</span>
            </>
          )}
          ...
          <div className="flex flex-col items-center">
            <div className={cn(
              ...
              <span className={cn(
                ...
                pomodoroState === "paused" ? "text-white/60" : isVideoBackground ? "text-white" : "text-foreground"
              )}>
                {pad(minutes)}
              </span>
            </div>
          ...
          <div className="flex flex-col items-center pb-6 lg:pb-8">
            <span className={cn(
              ...
              pomodoroState === "focusing" || pomodoroState === "breaking" ? "text-cyan-300 drop-shadow-[0_0_12px_rgba(34,211,238,0.8)] animate-pulse" : "text-white/40"
            )}>
              :
            </span>
          </div>
