...
export const formatLabel = (start: Date, end: Date, rangeType: "week" | "month" | "year", locale: string = "vi") => {
  const isVi = locale === "vi";
  const correctMonths = isVi 
