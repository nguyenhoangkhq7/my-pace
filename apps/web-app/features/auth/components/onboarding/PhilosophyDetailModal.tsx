...
export function PhilosophyDetailModal({ isOpen, onClose, title, detail }: PhilosophyDetailModalProps) {
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="sm:max-w-[600px] w-[95vw] rounded-3xl p-8 border-none bg-card shadow-2xl overflow-y-auto max-h-[90vh] duration-300 scrollbar-thin z-[100]">
        <DialogHeader>
